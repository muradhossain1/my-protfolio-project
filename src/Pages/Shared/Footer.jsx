    ...
    return (
        <div className="mt-12 bg-neutral ">
            <div className="flex items-center lg:mr-6 justify-center pt-6 gap-5">
                <Link to='/' className="text-xl md:ml-4 text-white md:text-4xl font-extrabold ">Md Murad Hossain</Link>
            </div>

            <footer className="flex flex-col md:flex-row gap-8 md:gap-32 justify-center text-neutral-content mt-3 p-4 md:px-10 lg:px-20 mb-6 ">
